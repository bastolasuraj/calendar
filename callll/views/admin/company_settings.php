<?php require_once 'views/templates/header.php'; ?>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="company_name" name="company_name"
                                       value="<?php echo htmlspecialchars($settings['company']['name'] ?? ''); ?>" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="company_website" class="form-label">Website URL</label>
                                <input type="url" class="form-control" id="company_website" name="company_website"
                                       value="<?php echo htmlspecialchars($settings['company']['website'] ?? ''); ?>"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" class="form-control" id="contact_email" name="contact_email"
                                       value="<?php echo htmlspecialchars($settings['company']['email'] ?? ''); ?>" required>
                                <div class="form-text">This will be used as the sender address for notifications</div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="contact_phone" class="form-label">Contact Phone</label>
                                <input type="tel" class="form-control" id="contact_phone" name="contact_phone"
                                       value="<?php echo htmlspecialchars($settings['company']['phone'] ?? ''); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="address" name="address" rows="3"
                                      placeholder="Enter your company's full address"><?php echo htmlspecialchars($settings['company']['address'] ?? ''); ?></textarea>
                        </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="timezone" name="timezone">
                                    ...
                                    foreach ($timezones as $value => $label):
                                        ?>
                                        <option value="<?php echo $value; ?>" <?php echo ($settings['working_hours']['timezone'] ?? '') === $value ? 'selected' : ''; ?>>
                                            <?php echo $label; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <?php if (!empty($settings['branding']['logo'])): ?>
                                    <div class="mt-2">
                                        <img src="<?php echo htmlspecialchars($settings['branding']['logo']); ?>"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="font_family" name="font_family">
                                    ...
                                    foreach ($fonts as $value => $label):
                                        ?>
                                        <option value="<?php echo $value; ?>" <?php echo ($settings['branding']['font_family'] ?? '') === $value ? 'selected' : ''; ?>>
                                            <?php echo $label; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="color" class="form-control form-control-color" id="primary_color"
                                           name="primary_color" value="<?php echo htmlspecialchars($settings['branding']['primary_color'] ?? ''); ?>">
                                    <input type="text" class="form-control" value="<?php echo htmlspecialchars($settings['branding']['primary_color'] ?? ''); ?>"
                                           readonly>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="color" class="form-control form-control-color" id="secondary_color"
                                           name="secondary_color" value="<?php echo htmlspecialchars($settings['branding']['secondary_color'] ?? ''); ?>">
                                    <input type="text" class="form-control" value="<?php echo htmlspecialchars($settings['branding']['secondary_color'] ?? ''); ?>"
                                           readonly>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="color" class="form-control form-control-color" id="accent_color"
                                           name="accent_color" value="<?php echo htmlspecialchars($settings['branding']['accent_color'] ?? ''); ?>">
                                    <input type="text" class="form-control" value="<?php echo htmlspecialchars($settings['branding']['accent_color'] ?? ''); ?>"
                                           readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="time" class="form-control" id="working_hours_start" name="working_hours_start"
                                       value="<?php echo htmlspecialchars($settings['working_hours']['start'] ?? ''); ?>">
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="time" class="form-control" id="working_hours_end" name="working_hours_end"
                                       value="<?php echo htmlspecialchars($settings['working_hours']['end'] ?? ''); ?>">
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select" id="slot_duration" name="slot_duration">
                                    ...
                                    foreach ($durations as $value => $label):
                                        ?>
                                        <option value="<?php echo $value; ?>" <?php echo ($settings['working_hours']['slot_duration'] ?? 0) == $value ? 'selected' : ''; ?>>
                                            <?php echo $label; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="max_advance_booking_days" name="max_advance_booking_days"
                                       value="<?php echo htmlspecialchars($settings['booking']['max_advance_days'] ?? ''); ?>" min="1" max="365">
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="min_advance_booking_hours" name="min_advance_booking_hours"
                                       value="<?php echo htmlspecialchars($settings['booking']['min_advance_hours'] ?? ''); ?>" min="0" max="72">
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" class="form-control" id="cancellation_hours_before" name="cancellation_hours_before"
                                       value="<?php echo htmlspecialchars($settings['booking']['cancellation_hours'] ?? ''); ?>" min="0" max="72">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="max_concurrent_bookings" name="max_concurrent_bookings"
                                       value="<?php echo htmlspecialchars($settings['booking']['max_concurrent_bookings'] ?? ''); ?>" min="1" max="10">
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="booking_buffer_minutes" name="booking_buffer_minutes"
                                       value="<?php echo htmlspecialchars($settings['booking']['booking_buffer_minutes'] ?? ''); ?>" min="0" max="60">
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="send_confirmation_emails"
                                               name="send_confirmation_emails" <?php echo ($settings['notification']['user_booking_confirmation'] ?? false) ? 'checked' : ''; ?>>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="send_reminder_emails"
                                               name="send_reminder_emails" <?php echo ($settings['notification']['user_booking_reminder'] ?? false) ? 'checked' : ''; ?>>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="reminder_hours_before" name="reminder_hours_before">
                                        ...
                                        foreach ($reminderHours as $value => $label):
                                            ?>
                                            <option value="<?php echo $value; ?>" <?php echo ($settings['notification']['reminder_hours_before'] ?? 0) == $value ? 'selected' : ''; ?>>
                                                <?php echo $label; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="booking_terms" name="booking_terms" rows="8"
                                      placeholder="Enter your booking terms and conditions..."><?php echo htmlspecialchars($settings['booking']['terms'] ?? ''); ?></textarea>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="auto_approve_bookings"
                                       name="auto_approve_bookings" <?php echo ($settings['booking']['auto_approve'] ?? false) ? 'checked' : ''; ?>>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="require_approval"
                                       name="require_approval" <?php echo ($settings['booking']['require_approval'] ?? false) ? 'checked' : ''; ?>>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="enable_public_calendar"
                                       name="enable_public_calendar" <?php echo ($settings['booking']['show_public_calendar'] ?? false) ? 'checked' : ''; ?>>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="enable_user_updates"
                                       name="enable_user_updates" <?php echo ($settings['booking']['allow_updates'] ?? false) ? 'checked' : ''; ?>>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="enable_user_cancellations"
                                       name="enable_user_cancellations" <?php echo ($settings['booking']['allow_cancellation'] ?? false) ? 'checked' : ''; ?>>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="<?php echo BASE_PATH; ?>/admin/form_builder" class="btn btn-outline-success">
    ...
    <style>
        ...
        :root {
            --primary-color: <?php echo htmlspecialchars($settings['branding']['primary_color'] ?? '#0d6efd'); ?>;
            --secondary-color: <?php echo htmlspecialchars($settings['branding']['secondary_color'] ?? '#6c757d'); ?>;
            --accent-color: <?php echo htmlspecialchars($settings['branding']['accent_color'] ?? '#198754'); ?>;
        }
    </style>
